			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td>
							<div class="form-row">
								...
								class="form-control" pattern="^[a-z0-9]{8,16}" maxlength="15" style="width:80%;display:inline-block;"
								 autofocus required />
					...
					<tr>
						<th>비밀번호</th>
						<td>
							<input type="password" name="pw" id="pw" placeholder="비밀번호 입력" class="form-control" 
					...
					<tr>
						<th>비밀번호 확인</th>
						<td><input type="password" name="pw2" id="pw2" placeholder="비밀번호  확인 입력" class="form-control"
