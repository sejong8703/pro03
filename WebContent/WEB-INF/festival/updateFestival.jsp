...
<div class="content" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px; ">
	<div class="container-fluid">
		<h2>글 수정</h2>
		<p>${msg }</p>
		<form action="${path1 }/UpdateFestivalPro.do" method="post" enctype="multipart/form-data">
			<table class="table">
				<tbody>
					<tr>
					...
					<tr>
						...
						<td>
							<span>
								<c:set var="lh" value="${fn:length(fes.file1) }" />
								<c:set var="download" value="${fn:substring(fes.file1,5,lh) }" />
								${download }
							</span><br>
